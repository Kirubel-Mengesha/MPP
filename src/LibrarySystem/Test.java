    ...
    public static void main(String[] args) {
       ...
       // uncomment when your code is ready
		...
		CD[] cds = {
				...
				new CD("102", "Sad", "Warner Bros",3),
				new CD("103", "Jumpin", "Mills Bros",4),
				new CD("104", "Frowning", "Mills Bros",1),
				new CD("105", "Joy", "Warner Bros",5)
		};

		Book[] books = {
				new Book("1040A5", "Gone with the Wind", "Bob", "Gearhart",6),
				new Book("5241C3", "The Unhappy Indian", "Richard", "Steigert",5),
				new Book("9982D1", "The Unseen Rock", "Stephen", "King",4),
				new Book("1112E5", "Hunting", "Danielle", "Steele",8),
				new Book("8008T4", "Overdrive", "Cougar", "Fox",3)
