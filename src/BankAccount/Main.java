...
public class Main {
    public static void main(String[] args) {
        ...
        someSavingAccounts[0] = new SavingAccount("44-8123", 0.03, 200);
        someSavingAccounts[1] = new SavingAccount("21-9672", 0.03, 200);
        someSavingAccounts[2] = new SavingAccount("68-0902", 0.04, 600);
