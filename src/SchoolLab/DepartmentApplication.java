...
public class DepartmentApplication
{
    public static void main(String[] args) throws IOException
    {
        ...
        //  addPerson (this replaces the other three methods).
         ...
         Student johnDoe = new Student("John Doe","472-1121",22,0,4.0);
         Student maryJones = new Student("Mary Jones","472-7322",32,0,3.80);
         Student leeJohnson = new Student("Lee Johnson","472-6009",19,0,3.65);
